...
<div class="w3-top" style="z-index:3;">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="display_blogs.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white" id="display" title="Admin area"><span class="material-symbols-outlined fs-1">account_circle</span></a>
  ...
  <div class="w3-dropdown-hover w3-hide-small">
    ...
    <div class="w3-dropdown-content w3-card-4 w3-bar-block" style="width:300px">  
        <a href="#" class="w3-bar-item w3-button"><?php echo sizeof($_SESSION['friend_request']);?> new friend request</a>
  ...
  <div class="w3-row">
    ...
    <div class="w3-col l3">
      ...
      <div class="w3-card w3-round w3-white">
        ...
        <button type="button" class="p-2 border-0 bg-transparent position-absolute" title="Edit profile picture" data-bs-toggle="modal" data-bs-target="#heroModal">
          <span style="border-radius:50%;border:2px solid #fff"class="bg-light  material-symbols-outlined w3-theme-d3">camera</span>
        </button>
             ...
             <!-- avatar image  -->
              <div class="ms-4 mt-5 pt-2 d-flex flex-column" style="width: 200px; height:270px;">             
                ...
                <button type="button" class="p-2 border-0 bg-transparent position-relative" title="Edit profile picture" 
                        data-bs-toggle="modal" data-bs-target="#avatarModal" style="bottom:50px; left:40px; z-index:5;">
                  <span style="border-radius:50%;"class="bg-light p-1 material-symbols-outlined w3-theme-d3">edit</span>
                </button>

              </div>

              <div class="ms-0" style="margin-top: 150px;">
                <h4 class="bg-light w3-theme-d1 px-3 py-2 rounded"><?php echo $_SESSION['a_user']; ?></h4>
              </div>
            </div>
            ...
            <div class="card-body px-4 pt-0 text-black">
              <div class="mt-2">
                ...
                <div class="p-4" style="background-color: #f8f9fa;">
                  <p class="font-italic mb-1"><?php echo $_SESSION['a_email']; ?></p>
                  <p class="font-italic mb-0">since <?php echo date('m-d-Y',strtotime($_SESSION['a_date']));?></p>
                </div>
              </div>
      ...
      <div class="w3-card w3-round">
        <div class="w3-white">
          <button onclick="myFunction('Demo1')" class="w3-button w3-block w3-theme-d2 w3-left-align"><i class="fa fas fa-users fa-fw w3-margin-right"></i> My Friends</button>
      ...
      <!-- id button with this              -->
                  ...
                  <button id="frBtn<?php echo $fq['user_id']?>" onclick="alert(this.id)">OK</button>
                    ...
                    <button type="button" id="delBtn<?php echo $fq['user_id']?>" name="submit" value="Send" style='border:none;background-color:transparent;' 
                            ...
                            <span id="" class="material-symbols-outlined w3-text-red me-3">delete</span>
                    </button>
                    <span id="frDel"></span>
              </form>   
          ...
          <button onclick="myFunction('Demo2')" class="w3-button w3-block w3-theme-d2 w3-left-align"><i class="fa fa-calendar-check-o fa-fw w3-margin-right"></i> My Events</button>
          <div id="Demo2" class="w3-hide w3-container">
            <p>....</p>
          </div>
          <button onclick="myFunction('Demo3')" class="w3-button w3-block w3-theme-d2 w3-left-align"><i class="fa far fa-image fa-fw w3-margin-right"></i> My Photos</button>
                ...
                <div class="d-flex justify-content-end">
                  ...
                  <form action="#" id="frm" class="border-0 bg-light">
                      ...
                      <button type="button" id="btn<?php echo $q['user_id'];?>" name="submit" value="Send" style='font-size:16px;border:none;background-color:transparent;' 
                                ...
                                class="p-0 border-none mx-4 text-danger">
    ...
    <div class="w3-col l6">
        ...
        <div class="w3-row-padding">
          ...
          <h3 class="font-italic mb-1 text-secondary p-3 protest-riot-regular text-secondary" id="feeling"><?php echo $_SESSION['a_feeling']; ?></h3>
    ...
    <div class="w3-car w3-round w3-white">
              ...
              <div class="w3-card w3-round w3-white  mt-1 mb-1">
                ...
                <h5 class="ms-2 text-secondary">Quick search</h5>
                  <div class="w3-container w3-padding">
                  <form>
                      <select name="users" class="form-control bg-light  my-1" onchange="showUser(this.value, 'titleBox')">
                        <option value="" class="form-control fs-5 lh-1" >Select from titles:</option>
                        ...
                        <?php 
                          ...
                          <option class="form-control fs-5 lh-1" style="width:28rem;"value="<?php echo $q['title'];?>"><?php echo $q['title'];?> </option>
                          <?php }?>
                      </select>
                    </form>
                  </div>
          ...
          <div class="w3-card w3-round w3-white w3-center">
            ...
            <!-- event  -->
            <div class="w3-container g-4 mb-2">
              <p>Upcoming Events:</p>
              <img src="https://bwwindowwashing.com/wp-content/uploads/happy-easter-images-wallpaper-picture-pic-cards-72.jpg" alt="Forest" style="width:100%;">
              <p><strong>Easter</strong></p>
              <p>Easter, or Resurrection Sunday, is a festival and holiday celebrating the resurrection of Jesus from the dead, described in the New Testament as having occurred on the third day of his burial after his crucifixion by the Romans at Calvary</p>
              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <div class="modal-body" style="height:200px;">
                    ...
                    <form action="#" id="frmHero" class="position-absolute bg-transparent border-0" style="width:100%;">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <div class="modal-body" style="height:200px;">
                    ...
                    <form action="#" id="frmAvatar" class="position-absolute bg-transparent border-0" style="width:100%;">
